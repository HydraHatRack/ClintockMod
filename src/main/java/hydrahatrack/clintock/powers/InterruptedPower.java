...
public class InterruptedPower extends AbstractPower {
    public static final String POWER_ID = "clintock:InterruptedPower";
    ...
    public InterruptedPower(final AbstractCreature owner) {
        this.ID = POWER_ID;
        this.name = NAME;
        this.owner = owner;
        this.img = IMG;
